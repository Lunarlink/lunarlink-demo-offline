...
export default function CouponBook() {
  ...
  async function getCouponBalance() {
    ...
    try {
      ...
      console.log("couponAddress", couponAddress.toBase58())
      console.log("userCouponAddress", userCouponAddress.toBase58())
      console.log("userCouponAccoun", userCouponAccount)


      const couponMint = await getMint(connection, couponAddress)
      console.log("coupon asdas ", couponMint.decimals)
